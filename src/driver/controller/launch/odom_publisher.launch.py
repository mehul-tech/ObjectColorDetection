...
def generate_launch_description():
    ...
    if compiled == 'True':
        ...
        # EDIT wentao/
        home_dir = os.environ.get('HOME', '/home/wentao')
        rosmentor_description_package_path = os.path.join(home_dir, 'elec555_ws/src/simulator')
        robot_controller_package_path = os.path.join(home_dir, 'elec555_ws/src/driver/ros_robot_controller')
        controller_package_path = os.path.join(home_dir, 'elec555_ws/src/driver/controller')
